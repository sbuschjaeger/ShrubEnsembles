...
py::class_<DistanceDecisionTree<DDT::TREE_INIT::TRAIN, DDT::DISTANCE::ZLIB, OPTIMIZER::NONE>>(m, "DistanceDecisionTreeTrainNone")
    ...
    .def("num_bytes", &DistanceDecisionTree<DDT::TREE_INIT::TRAIN, DDT::DISTANCE::ZLIB, OPTIMIZER::NONE>::num_bytes)
    .def("num_nodes", &DistanceDecisionTree<DDT::TREE_INIT::TRAIN, DDT::DISTANCE::ZLIB, OPTIMIZER::NONE>::num_nodes)
    .def("load", &DistanceDecisionTree<DDT::TREE_INIT::TRAIN, DDT::DISTANCE::ZLIB, OPTIMIZER::NONE>::load, py::arg("new_nodes"), py::arg("new_leafs"))
    .def("store", &DistanceDecisionTree<DDT::TREE_INIT::TRAIN, DDT::DISTANCE::ZLIB, OPTIMIZER::NONE>::store)
    .def("fit", py::overload_cast<matrix2d<data_t> const &, matrix1d<unsigned int> const &>(&DistanceDecisionTree<DDT::TREE_INIT::TRAIN, DDT::DISTANCE::ZLIB, OPTIMIZER::NONE>::fit), py::arg("X"), py::arg("Y")
